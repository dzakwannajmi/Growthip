// Sole owner of the Baby Jubjub curve constants for the shielded module.
// Wraps circomlibjs so it stays in lockstep with circomlib's BabyPbk / EscalarMul*.
// Vendored from fxjrin/cyphras extension/src/shielded/babyjub.ts (Apache-2.0),
// with Buffer usage replaced by browser-safe helpers.
...
export function randScalar(): bigint {
  ...
  return bytesToBigInt(b) % SUBGROUP_ORDER;
}
